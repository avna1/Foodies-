 ...
 <div class="container-fluid p-0">
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
             ...
             <img class="fod-light" src="pictures+video/kk2.jpg"  width="1920" height="500px"class="d-inline-block align-top" alt="">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
					<div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Foodly</h5>
                            <h1 class="display-3 text-white mb-md-4"> See your orders here !</h1>
        ...
        <div class="container">
        	...
        	<div class="col-lg-8">
        		...
        		if(isset($_SESSION['login_user_id'])){
					...
					$ip = $_SERVER['HTTP_CLIENT_IP'] ? $_SERVER['HTTP_CLIENT_IP'] : ($_SERVER['X_FORWARDED_FOR'] ? $_SERVER['HTTP_X_FORWARDED_FOR'] : $_SERVER['REMOTE_ADDR']);
